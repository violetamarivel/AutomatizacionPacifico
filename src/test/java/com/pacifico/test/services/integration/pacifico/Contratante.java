...
public class Contratante{
	...
	private List<ArchivoAdjuntosItem> archivoAdjuntos;
	...
	public void setMontoIngresoAnual(int montoIngresoAnual){
		this.montoIngresoAnual = montoIngresoAnual;
	}

	public int getMontoIngresoAnual(){
		return montoIngresoAnual;
	}
	...
	public void setArchivoAdjuntos(List<ArchivoAdjuntosItem> archivoAdjuntos){
		this.archivoAdjuntos = archivoAdjuntos;
	}

	public List<ArchivoAdjuntosItem> getArchivoAdjuntos(){
		return archivoAdjuntos;
	}
